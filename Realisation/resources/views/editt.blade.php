				...
				<div class="row">
					<div class="col">
								<div class="search-box">
									...
									<input type="text" id="search" class="form-control  searchInput" placeholder="modifier">
								</div>
					</div>
					<div class="col-sm-6">
						<a href="#addEmployeeModal" class="btn btn-success" data-toggle="modal"> <i class="material-icons">&#xE147;</i><span>modifier Promotion</span></a>
					</div>
				</div>
			</div>
